...
//        {
//            if (animal != null && (animal.Size <= this.Size || animal.GetType().Name == "Zombie"))
//            {
...
//            {
//                this.Size++;  //maybe I'll have here a problem with the number of increasing of the grass' size
//            }
//            base.Update(time);
//        }
//    }
...
//        public int TryEatAnimal(Animal animal)
//        {
//            if (animal != null && (animal.Size <= 2 * this.Size || animal.GetType().Name == "Zombie"))
//            {
//                this.Size++;
//                return animal.GetMeatFromKillQuantity();
//            }
